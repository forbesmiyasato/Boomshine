...
public class ExplodingBoundedMovingCircle extends BoundedMovingSprite {
   ...
   */
  ExplodingBoundedMovingCircle(ExplodingType eType, Context context, Display display,
                               int drawable, int topCoord, int leftCoord, int speed,
                               int topBound, int bottomBound, int leftBound, int rightBound,
                               int radius)
  {
    super(context, display, drawable, topCoord, leftCoord, speed, topBound, bottomBound,
