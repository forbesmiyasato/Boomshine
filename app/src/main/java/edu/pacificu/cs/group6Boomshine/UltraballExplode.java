...
/**
 * Creates an UltraballExplode class that defines creation of
 * the Ultra Ball ExplodingBoundedMovingCircle power up.
 *
...
public class UltraballExplode {
    ...
    public ArrayList<ExplodingBoundedMovingCircle> createUltra(ExplodingType eType,
